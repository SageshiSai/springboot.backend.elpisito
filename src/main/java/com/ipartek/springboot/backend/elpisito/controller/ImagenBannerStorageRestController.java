...
import com.ipartek.springboot.backend.elpisito.storage.IImagenBannerStorageService;
...
public class ImagenBannerStorageRestController {
    ...
    @Autowired
    private IImagenBannerStorageService imagenBannerStorageService; //Podemos utilizar la Interface (IImagenStorageService) en vez de la implementación (ImagenStorageServiceImpl) porque polimorficamente son compatibles
